...
class Ui_magnetAppStartup(object):
    def setupUi(self, magnetAppStartup):
        ...
        self.CLAR_INJ = QtGui.QRadioButton(self.machineAreaSelection)
        self.CLAR_INJ.setObjectName(_fromUtf8("CLAR_INJ"))
        self.verticalLayout_3.addWidget(self.CLAR_INJ)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem)
        self.CLAR_INJ.raise_()
    ...
    def retranslateUi(self, magnetAppStartup):
        ...
        self.CLAR_INJ.setText(_translate("magnetAppStartup", "CLARA INJ Magnets", None))
