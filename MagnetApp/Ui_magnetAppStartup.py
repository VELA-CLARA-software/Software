...
class Ui_magnetAppStartup(object):
    def setupUi(self, magnetAppStartup):
        ...
        self.VELA_INJ_Magnets = QtGui.QRadioButton(self.machineAreaSelection)
        self.VELA_INJ_Magnets.setObjectName(_fromUtf8("VELA_INJ_Magnets"))
        self.verticalLayout_3.addWidget(self.VELA_INJ_Magnets)
        self.VELA_BA1_Magnets = QtGui.QRadioButton(self.machineAreaSelection)
        self.VELA_BA1_Magnets.setObjectName(_fromUtf8("VELA_BA1_Magnets"))
        self.verticalLayout_3.addWidget(self.VELA_BA1_Magnets)
        self.VELA_BA2_Magnets = QtGui.QRadioButton(self.machineAreaSelection)
        self.VELA_BA2_Magnets.setObjectName(_fromUtf8("VELA_BA2_Magnets"))
        self.verticalLayout_3.addWidget(self.VELA_BA2_Magnets)
        self.CLAR_INJ_Magnets = QtGui.QRadioButton(self.machineAreaSelection)
        self.CLAR_INJ_Magnets.setObjectName(_fromUtf8("CLAR_INJ_Magnets"))
        self.verticalLayout_3.addWidget(self.CLAR_INJ_Magnets)
        spacerItem = QtGui.QSpacerItem(20, 40, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.verticalLayout_3.addItem(spacerItem)
        self.CLAR_INJ_Magnets.raise_()
        self.VELA_BA2_Magnets.raise_()
        self.VELA_BA1_Magnets.raise_()
        self.VELA_INJ_Magnets.raise_()
        ...
        self.machineAreaSelection.raise_()
        self.modeSelection.raise_()
        self.instructionLabel.raise_()
        self.iconLabel.raise_()
        self.waitMessageLabel.raise_()
    ...
    def retranslateUi(self, magnetAppStartup):
        ...
        self.VELA_INJ_Magnets.setText(_translate("magnetAppStartup", "VELA  INJ Magnets", None))
        self.VELA_BA1_Magnets.setText(_translate("magnetAppStartup", "VELA  BA1 Magnets", None))
        self.VELA_BA2_Magnets.setText(_translate("magnetAppStartup", "VELA  BA2 Magnets", None))
        self.CLAR_INJ_Magnets.setText(_translate("magnetAppStartup", "CLARA INJ Magnets", None))
