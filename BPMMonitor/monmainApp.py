...
class monApp(QtGui.QApplication):
    def __init__(self, sys_argv):
        ...
        self.model = monmainModel.monModel(self.bpmCont, self.scopeCont)
        self.controller = monmainController.monController(self.view, self.model, self.bpmCont, self.scopeCont)
