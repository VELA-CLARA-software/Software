...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.comboBox_mode = QtGui.QComboBox(self.groupBox_input)
        self.comboBox_mode.setObjectName(_fromUtf8("comboBox_mode"))
        self.comboBox_mode.addItem(_fromUtf8(""))
        self.comboBox_mode.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.comboBox_mode, 0, 3, 1, 1)
        self.comboBox_line = QtGui.QComboBox(self.groupBox_input)
        self.comboBox_line.setObjectName(_fromUtf8("comboBox_line"))
        self.comboBox_line.addItem(_fromUtf8(""))
        self.comboBox_line.addItem(_fromUtf8(""))
        self.gridLayout_2.addWidget(self.comboBox_line, 0, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_mode.setItemText(0, _translate("MainWindow", "Virtual", None))
        self.comboBox_mode.setItemText(1, _translate("MainWindow", "Physical", None))
        self.comboBox_line.setItemText(0, _translate("MainWindow", "VELA", None))
        self.comboBox_line.setItemText(1, _translate("MainWindow", "CLARA", None))
