...
normal_RF_increase = 80  # RF step increment
...
while True:
    ...
    if (time.time() - loop_start_time) % 60 < 0.05:
        if breakdown_count > 0:
            ...
            print 'Breakdown rate is ' + str(breakdown_per_minute) + ' breakdowns/minute (' + str(breakdown_per_minute * 30) + ' breakdowns/30mins with ' + str(breakdown_count) + ' breakdowns)'
        #breakdown_count = 0
        #loop_start_time = time.time
