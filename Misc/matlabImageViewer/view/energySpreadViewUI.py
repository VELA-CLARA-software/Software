...
class energySpreadViewUI(object):
    ...
    def setupUi(self, mainWindow):
        ...
        self.metaAnalysisPlotVBox = QtGui.QVBoxLayout()
        self.clearCurrentFileVBox = QtGui.QVBoxLayout()
        ...
        self.setMATOrHDF5Layout = QtGui.QHBoxLayout()
        self.setMATOrHDF5 = QtGui.QGroupBox()
        self.setMATOrHDF5.setAlignment(QtCore.Qt.AlignCenter)
        self.setMATOrHDF5.setGeometry(QtCore.QRect(360, 140, 193, 211))
        self.setMAT = QtGui.QRadioButton()
        self.setMAT.setObjectName(_fromUtf8('setMAT'))
        self.setMAT.setMinimumSize(QtCore.QSize(100, 20))
        self.setHDF5 = QtGui.QRadioButton()
        self.setHDF5.setObjectName(_fromUtf8('setFile'))
        self.setHDF5.setMinimumSize(QtCore.QSize(100, 20))
        self.setMATOrHDF5Layout.addWidget(self.setMAT)
        self.setMATOrHDF5Layout.addWidget(self.setHDF5)
        self.setMATOrHDF5.setLayout(self.setMATOrHDF5Layout)
        ...
        self.convertFilesButton = QtGui.QPushButton('Convert to HDF5?', self)
        ...
        self.selectFileLayout = QtGui.QHBoxLayout()
        self.setLayout(self.selectFileLayout)
        ...
        self.configVBox.addWidget(self.setMATOrHDF5)
        ...
        self.configVBox.addLayout(self.selectFileLayout)
        ...
        self.metaAnalysisPlotButton = QtGui.QPushButton('Analyse all results', self)
        self.metaAnalysisPlotVBox.addWidget(self.metaAnalysisPlotButton)
        self.metaAnalysisPlotVBox.addStretch()
        self.clearCurrentFileButton = QtGui.QPushButton('Clear current file', self)
        self.clearCurrentFileVBox.addWidget(self.clearCurrentFileButton)
        self.clearCurrentFileVBox.addStretch()
        ...
        self.plotsVBox.addLayout(self.metaAnalysisPlotVBox)
        self.plotsVBox.addLayout(self.clearCurrentFileVBox)
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.readFilesButton.setText(_translate('mainWindow', 'Read files', None))
        self.allFilesLabel.setText(_translate('mainWindow', 'Files in folder', None))
        self.setMAT.setText(_translate('mainWindow', 'Set .mat', None))
