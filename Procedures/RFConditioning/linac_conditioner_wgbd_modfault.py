...
""" LOUISE: Ky fwd Upper limit, LLRF interlock CLA-L01-LRF-CTRL-01:app:interlock:state, save fwd power trace """
...
class linac_condition(QObject):
    ...
    def __init__(self, parent = None):
        ...
        self.rev_trace_log = "breakdown_trace.txt"
        self.probe_trace_log = "breakdown_trace_probe.txt"
        # toggle actualy doing conditioning!
        self.doConditioning = False
        self.incooldown = False

        # tweakable parameters
        self.normal_RF_increase = 30;  # RF step increment
        ...
        self.rf_upper_limit    = 12200  # Based on 8/9/17 data, should be about 40MW
        ...
        self.pv_to_monitor = {
            ...
            'LLRF_CAVITY_FWD_PWR'   : epics.PV('CLA-L01-LRF-CTRL-01:ad1:ch3:power_remote.POWER'),
            'LLRF_PROBE_FWD_PWR'    : epics.PV('CLA-L01-LRF-CTRL-01:ad1:ch6:power_remote.POWER'),
    ...
    def getInitialValues(self):
        ...
        self.fwd_pwr_mean = sum( epics.PV('CLA-L01-LRF-CTRL-01:ad1:ch4:power_remote.POWER').get() )
        self.amp_mean = epics.PV('CLA-L01-LRF-CTRL-01:ad1:ch4:power_remote.POWER').get()
        self.trig_mean = epics.PV('CLA-L01-HRF-MOD-01:FAULT').get()
        for i in range(11):
    ...
    def update_RF_trig_buffer(self):
        self.last_10_trig_values.append(epics.PV('CLA-L01-HRF-MOD-01:FAULT').get())
