...
# v0.1 - Inherited script from Louise Cowie - Many changes made to get the script working, lots of PV names were wrong
# v0.2 - Modified extensively to allow it to work with Modulator faults and Trig faults.
# v0.3 - Small changes to VAC Spike detection
...
class linac_condition(QObject):
    ...
    def __init__(self, parent = None):
        ...
        self.droppedRFpowerduetotrip = True
        ...
        self.pv_to_monitor = {
            ...
            'RF_TRIG'               : epics.PV('CLA-GUNS-HRF-MOD-01:Sys:StateSet'),
        ...
        if self.rf_dropped:
            ...
            if self.is_not_in_cool_down(rf_permit_signal):
                ...
                if self.rf_permit_lost:
                    if self.droppedRFpowerduetotrip is False:
            ...
            self.droppedRFpowerduetotrip = False
    ...
    def change_RF_amp(self, rf_amp_signal, value):
        if value < 0:
            self.pv_to_monitor[rf_amp_signal].put(0)
        elif value > self.rf_upper_limit:
            self.pv_to_monitor[rf_amp_signal].put(self.rf_upper_limit)
        else:
    ...
    def check_IMG_change_is_small(self, img_signal, rf_amp_signal, rf_pulse_width_signal):
        if self.rf_dropped is False and self.rf_trig_lost is False:
            ...
            if not self.incooldown and self.delta_IMG > self.pv_monitor_not_alarm_values[img_signal]:
                ...
                while self.delta_IMG > self.pv_monitor_not_alarm_values[img_signal]:
                    print 'Sleeping for 2 seconds due to VAC spike - delta = ', self.delta_IMG
