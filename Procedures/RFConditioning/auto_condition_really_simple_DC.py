...
number_of_samples_to_average = 50 # Number of samples we average to decide if we have tripped (note at 10Hz, 10 samples == 1sec...)
...
rf_upper_limit    = 19500 # AW suggestion 16800
maximum_pulse_width = 3 # Absolute max pulse length
nominal_pulse_width = 2.5 # Pulse width we should be at if all is well
...
vac_spike_RF_pulse_width_drop = 0.05 #pulse width amount to drop when IMG spike
...
'DC'          			: 2*60,  	# vac_spike_cooldown_time	 NOT LESS THAN 1 !!
'LLRF_CAVITY_REV_POWER' : 2*60,  	# vac_spike_cooldown_time	 NOT LESS THAN 1 !!
...
'DC': 0.3   # This is the level above background at which the pulse width drops
}
