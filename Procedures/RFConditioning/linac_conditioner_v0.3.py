...
class linac_condition(QObject):
    ...
    def __init__(self, parent = None):
        ...
        self.pv_monitor_not_alarm_values= {
            'RF_PERMIT': 65535,
            'RF_TRIG': 0,
            'LLRF_CAVITY_REV_POWER': 2, #factor x background for reflected power spike to be detected
        ...
        self.reset_rf_decrease = 40 #amount to decrease from previous rf value when coming back on after breakdown
        ...
        if self.latest_values[ref_signal] is not None:
            ...
            if max_rev_power  > self.pv_monitor_not_alarm_values[ref_signal]*self.rev_pwr_mean:
                if self.is_not_in_cool_down(ref_signal):
                    ...
                    print 'max_rev_power ' + str(max_rev_power) + ' rev_pwr_mean ' + str(self.rev_pwr_mean)
