...
"}"))
        ...
        self.pushButton_refreshImage.setGeometry(QtCore.QRect(500, 10, 91, 22))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 40, 575, 131))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"QLabel{ background-color: rgba(0,0,0,0%);}"))
        ...
        self.groupBox_9.setGeometry(QtCore.QRect(10, 180, 581, 371))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.groupBox_9.setFont(font)
        self.groupBox_9.setStyleSheet(_fromUtf8("QGroupBox{ background-color: rgb(55, 0, 55);}\n"
"QLabel{ background-color: rgba(0,0,0,0%);}\n"
"#QPushButton{ background-color: rgb(255, 255, 255);}"))
        ...
        self.groupBox_4.setGeometry(QtCore.QRect(10, 160, 561, 201))
        font = QtGui.QFont()
        font.setItalic(True)
        ...
        self.gridLayout_4.addWidget(self.pushButton_Align_2, 1, 0, 2, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_Align_4, 4, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_Align_3, 3, 0, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.pushButton_Align_2_B, 2, 1, 2, 1)
        self.comboBox_dipole = QtGui.QComboBox(self.groupBox_run)
        self.comboBox_dipole.setGeometry(QtCore.QRect(262, 20, 111, 22))
        ...
        self.label_I_3.setGeometry(QtCore.QRect(180, 20, 81, 20))
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(10, 560, 291, 120))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"#QPushButton{ background-color: rgb(255, 255, 255);}"))
        ...
        self.pushButton_CentreC2V_2 = QtGui.QPushButton(self.groupBox_5)
        self.pushButton_CentreC2V_2.setChecked(False)
        self.pushButton_CentreC2V_2.setObjectName(_fromUtf8("pushButton_CentreC2V_2"))
        self.verticalLayout.addWidget(self.pushButton_CentreC2V_2)
        ...
        self.verticalLayout.addWidget(self.pushButton_CentreC2V)
        ...
        self.verticalLayout.addWidget(self.pushButton_CalcMom)
        self.groupBox_6 = QtGui.QGroupBox(self.groupBox_run)
        self.groupBox_6.setGeometry(QtCore.QRect(310, 560, 281, 120))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
...
"#QPushButton{ background-color: rgb(255, 255, 255);}"))
        ...
        self.pushButton_CentreC2V_3 = QtGui.QPushButton(self.groupBox_6)
        self.pushButton_CentreC2V_3.setChecked(False)
        self.pushButton_CentreC2V_3.setObjectName(_fromUtf8("pushButton_CentreC2V_3"))
        self.verticalLayout_2.addWidget(self.pushButton_CentreC2V_3)
        self.pushButton_CentreC2V_4 = QtGui.QPushButton(self.groupBox_6)
        self.pushButton_CentreC2V_4.setChecked(False)
        self.pushButton_CentreC2V_4.setObjectName(_fromUtf8("pushButton_CentreC2V_4"))
        self.verticalLayout_2.addWidget(self.pushButton_CentreC2V_4)
        self.pushButton_CalcMom_2 = QtGui.QPushButton(self.groupBox_6)
        self.pushButton_CalcMom_2.setChecked(False)
        self.pushButton_CalcMom_2.setObjectName(_fromUtf8("pushButton_CalcMom_2"))
        self.verticalLayout_2.addWidget(self.pushButton_CalcMom_2)
        self.pushButton_refreshImage.raise_()
        self.groupBox.raise_()
        self.pushButton_Prelim_4.raise_()
        self.groupBox_9.raise_()
        self.comboBox_dipole.raise_()
        self.label_I_3.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Converter:", None))
        self.label_RF.setText(_translate("MainWindow", "TextLabel", None))
        ...
        self.groupBox_9.setTitle(_translate("MainWindow", "Fine measurement setup:", None))
        ...
        self.pushButton_CentreC2V_2.setText(_translate("MainWindow", "Get approximate momentum from converter", None))
        self.pushButton_CentreC2V.setText(_translate("MainWindow", "Scan dipole to centre down spectometer line", None))
        self.pushButton_CalcMom.setText(_translate("MainWindow", "Calculate momentum", None))
        self.groupBox_6.setTitle(_translate("MainWindow", "Set momentum:", None))
        self.pushButton_CentreC2V_3.setText(_translate("MainWindow", "Set current from converter", None))
        self.pushButton_CentreC2V_4.setText(_translate("MainWindow", "Scan RF to centre down spectometer line", None))
        self.pushButton_CalcMom_2.setText(_translate("MainWindow", "Calculate momentum", None))
