...
class Controller():
	...
	def __init__(self, view, model):
		...
		self.positionGraph_4 = layout.addPlot(title="Screen")
	...
	def updateDisplays(self):
		...
		self.bg4.setOpts(x=self.xdict.keys(), height=[1000*self.model.Cbpms.getXFromPV('C2V-BPM01'),1000*self.model.Cbpms.getYFromPV('C2V-BPM01')], width=1)
