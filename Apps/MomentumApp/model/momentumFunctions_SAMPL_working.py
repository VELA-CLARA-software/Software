...
class Functions(QObject):
    ...
    def minimisebeta_thread(self,qctrl,quad,sctrl,screen,init_step,N=1):
        self.threadObject = self.threadMethod(self, minimisebetaclass, qctrl,quad,sctrl,screen,init_step,self.simulate)

    class threadMethod(QObject):
