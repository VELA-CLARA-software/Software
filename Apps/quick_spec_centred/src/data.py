...
x_proj_2_rolling_sum = 'x_proj_2_rolling_sum'
y_proj_2_rolling_sum = 'y_proj_2_rolling_sum'
...
all_value_keys = [image_data,x_proj, y_proj, x_proj_rolling_sum ,y_proj_rolling_sum ,x_proj_mean ,
                  ...
                  y_proj_max_index, fwhm, fwhm_lo, fwhm_hi, got_image, x_proj_temp, x_proj_2, x_ref_2,
                  x_proj_2_rolling_sum ,y_proj_2_rolling_sum, fwhm_lo, fwhm_hi]
