...
class classmachine(QtCore.QObject):
    ...
    def set_sol(self, mag_control, cam_control, charge_control, rf_control, sol, bsol, rf):
        ...
        print 'SOL', 'BSOL'
        while mag_control.getRI('SOL') != sol or mag_control.getRI('QUAD01') != bsol:                        # on a PHYSICAL machine add tolerance- beacuse it will never give an accurate value, within 0.1A
