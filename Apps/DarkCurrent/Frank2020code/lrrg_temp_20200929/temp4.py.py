...
#        exit()
        ...
        for i in range(number_rf_vals):
            # I want to set 6.5 7.0 7.5 MW Using Archive looking at
            # CLA-GUN-LRF-CTRL-01:ad1:ch1:Power:Wnd:Avg and CLA-GUN-LRF-CTRL-01:ARCH:SP_AMP
            # I get SP/PWR = 57000/6.4,  61000/7.0, 63500/7.5 
     
            setvalue = [57000, 61000, 63500]                
            rf_control.setAmpSP(setvalue[i])
            while (rf_control.getAmpFF()-setvalue[i])>1:
                time.sleep(1)
                clock2+=1
                if clock2>10:
...
#        print '\n'
        ...
        print '==============================================================================================='
        print '\n'
        print 'Mean Charge:'+str(result[0])+' +-'+str(result[1])+'pC'
        print '\n'
