...
class bpm_charge_plotter(QtGui.QApplication):
	def __init__(self, argv):
		# you need this init line here to instantiate a QTApplication
		QtGui.QApplication.__init__(self, argv)
		# Everything else is handled by a main _controller
		self.controller = main_controller(argv, config_file='bpm_charge_plotter.config')


if __name__ == '__main__':
	print('Starting bpm_charge_plotter Application')
	app = bpm_charge_plotter(sys.argv)
	sys.exit(app.exec_())