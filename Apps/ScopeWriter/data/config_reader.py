...
class config_reader(object):
    ...
    def get_machine_area(self,text):
        if text == 'S01':
            return VELA_CLARA_enums.MACHINE_AREA.CLARA_S01
        elif text == 'VELA_INJ':
            return VELA_CLARA_enums.MACHINE_AREA.VELA_INJ
        elif text == 'CLARA_PH1':
            return VELA_CLARA_enums.MACHINE_AREA.CLARA_PH1
        else:
            return VELA_CLARA_enums.MACHINE_AREA.UNKNOWN_AREA