...
# Form implementation generated from reading ui file 'view1_5.ui'
#
...
"}"))
        ...
        self.label.setGeometry(QtCore.QRect(20, 30, 126, 16))
        self.label.setObjectName(_fromUtf8("label"))
        self.lineEdit_predictMom = QtGui.QLineEdit(self.groupBox_run)
        self.lineEdit_predictMom.setGeometry(QtCore.QRect(160, 30, 109, 22))
        ...
        self.pushButton_refreshImage.setGeometry(QtCore.QRect(1040, 170, 91, 22))
        self.pushButton_refreshImage.setObjectName(_fromUtf8("pushButton_refreshImage"))
        self.pushButton_CentreC2V = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_CentreC2V.setGeometry(QtCore.QRect(20, 150, 198, 22))
        self.pushButton_CentreC2V.setChecked(False)
        self.pushButton_CentreC2V.setObjectName(_fromUtf8("pushButton_CentreC2V"))
        self.pushButton_CalcMom = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_CalcMom.setGeometry(QtCore.QRect(20, 180, 137, 22))
        self.pushButton_CalcMom.setChecked(False)
        self.pushButton_CalcMom.setObjectName(_fromUtf8("pushButton_CalcMom"))
        self.pushButton_Align = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_Align.setGeometry(QtCore.QRect(20, 90, 141, 22))
        self.pushButton_Align.setChecked(False)
        self.pushButton_Align.setObjectName(_fromUtf8("pushButton_Align"))
        self.pushButton_Prelim = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_Prelim.setGeometry(QtCore.QRect(20, 60, 353, 22))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_Prelim.sizePolicy().hasHeightForWidth())
        self.pushButton_Prelim.setSizePolicy(sizePolicy)
        self.pushButton_Prelim.setMinimumSize(QtCore.QSize(140, 0))
        self.pushButton_Prelim.setMaximumSize(QtCore.QSize(371, 16777215))
        self.pushButton_Prelim.setChecked(False)
        self.pushButton_Prelim.setObjectName(_fromUtf8("pushButton_Prelim"))
        self.pushButton_Align_2 = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_Align_2.setGeometry(QtCore.QRect(170, 90, 141, 22))
        self.pushButton_Align_2.setChecked(False)
        self.pushButton_Align_2.setObjectName(_fromUtf8("pushButton_Align_2"))
        self.comboBox = QtGui.QComboBox(self.groupBox_run)
        self.comboBox.setGeometry(QtCore.QRect(20, 120, 181, 22))
        ...
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.addItem(_fromUtf8(""))
        self.doubleSpinBox = QtGui.QDoubleSpinBox(self.groupBox_run)
        self.doubleSpinBox.setGeometry(QtCore.QRect(210, 120, 62, 22))
        self.doubleSpinBox.setMinimum(-10.0)
        self.doubleSpinBox.setMaximum(10.0)
        self.doubleSpinBox.setSingleStep(0.1)
        self.doubleSpinBox.setObjectName(_fromUtf8("doubleSpinBox"))
        self.doubleSpinBox_2 = QtGui.QDoubleSpinBox(self.groupBox_run)
        self.doubleSpinBox_2.setGeometry(QtCore.QRect(280, 120, 62, 22))
        ...
        self.doubleSpinBox_3 = QtGui.QDoubleSpinBox(self.groupBox_run)
        self.doubleSpinBox_3.setGeometry(QtCore.QRect(350, 120, 62, 22))
        self.doubleSpinBox_3.setSingleStep(0.01)
        self.doubleSpinBox_3.setProperty("value", 0.05)
        self.doubleSpinBox_3.setObjectName(_fromUtf8("doubleSpinBox_3"))
        self.pushButton_Align_x = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_Align_x.setGeometry(QtCore.QRect(420, 120, 71, 22))
        self.pushButton_Align_x.setChecked(False)
        self.pushButton_Align_x.setObjectName(_fromUtf8("pushButton_Align_x"))
        self.pushButton_Align_y = QtGui.QPushButton(self.groupBox_run)
        self.pushButton_Align_y.setGeometry(QtCore.QRect(500, 120, 71, 22))
        self.pushButton_Align_y.setChecked(False)
        self.pushButton_Align_y.setObjectName(_fromUtf8("pushButton_Align_y"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Predicted Momentum:", None))
        ...
        self.pushButton_Align.setText(_translate("MainWindow", "2. Align Through Dipole", None))
        self.pushButton_Prelim.setText(_translate("MainWindow", "1. Preliminaries (set S02-DIP-01=0 and switch to S02-CAM-02)", None))
        self.pushButton_Align_2.setText(_translate("MainWindow", "2.1 Align on S01-BPM01", None))
        self.comboBox.setItemText(0, _translate("MainWindow", "S01-BPM01", None))
        self.comboBox.setItemText(1, _translate("MainWindow", "S02-BPM01", None))
        self.comboBox.setItemText(2, _translate("MainWindow", "S02-BPM02", None))
        self.comboBox.setItemText(3, _translate("MainWindow", "C2V-BPM01", None))
        self.pushButton_Align_x.setText(_translate("MainWindow", "Align x", None))
        self.pushButton_Align_y.setText(_translate("MainWindow", "Align y", None))
