...
# Form implementation generated from reading ui file 'view1_6.ui'
#
...
"}"))
        ...
        self.comboBox_1.addItem(_fromUtf8(""))
        self.comboBox_1.addItem(_fromUtf8(""))
        self.doubleSpinBox_1_x = QtGui.QDoubleSpinBox(self.groupBox_run)
        self.doubleSpinBox_1_x.setGeometry(QtCore.QRect(360, 50, 62, 22))
        self.doubleSpinBox_1_x.setMinimum(-10.0)
        self.doubleSpinBox_1_x.setMaximum(10.0)
        self.doubleSpinBox_1_x.setSingleStep(0.1)
        self.doubleSpinBox_1_x.setObjectName(_fromUtf8("doubleSpinBox_1_x"))
        self.doubleSpinBox_1_y = QtGui.QDoubleSpinBox(self.groupBox_run)
        self.doubleSpinBox_1_y.setGeometry(QtCore.QRect(430, 50, 62, 22))
        self.doubleSpinBox_1_y.setMinimum(-10.0)
        self.doubleSpinBox_1_y.setMaximum(10.0)
        self.doubleSpinBox_1_y.setSingleStep(0.1)
        self.doubleSpinBox_1_y.setObjectName(_fromUtf8("doubleSpinBox_1_y"))
        self.doubleSpinBox_1_tol = QtGui.QDoubleSpinBox(self.groupBox_run)
        self.doubleSpinBox_1_tol.setGeometry(QtCore.QRect(500, 50, 62, 22))
        self.doubleSpinBox_1_tol.setSingleStep(0.01)
        self.doubleSpinBox_1_tol.setProperty("value", 0.05)
        self.doubleSpinBox_1_tol.setObjectName(_fromUtf8("doubleSpinBox_1_tol"))
        ...
        self.comboBox_1_H = QtGui.QComboBox(self.groupBox_run)
        self.comboBox_1_H.setGeometry(QtCore.QRect(140, 50, 101, 22))
        self.comboBox_1_H.setEditable(False)
        self.comboBox_1_H.setMaxVisibleItems(10)
        self.comboBox_1_H.setObjectName(_fromUtf8("comboBox_1_H"))
        self.comboBox_1_H.addItem(_fromUtf8(""))
        self.comboBox_1_V = QtGui.QComboBox(self.groupBox_run)
        self.comboBox_1_V.setGeometry(QtCore.QRect(250, 50, 101, 22))
        self.comboBox_1_V.setEditable(False)
        self.comboBox_1_V.setMaxVisibleItems(10)
        self.comboBox_1_V.setObjectName(_fromUtf8("comboBox_1_V"))
        self.comboBox_1_V.addItem(_fromUtf8(""))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_1.setItemText(1, _translate("MainWindow", "S02-BPM01", None))
        self.comboBox_1.setItemText(2, _translate("MainWindow", "S02-BPM02", None))
        self.comboBox_1.setItemText(3, _translate("MainWindow", "C2V-BPM01", None))
        ...
        self.comboBox_1_H.setItemText(0, _translate("MainWindow", "S01-HCOR1", None))
        self.comboBox_1_V.setItemText(0, _translate("MainWindow", "S01-VCOR1", None))
