...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.finishButton = QtGui.QPushButton(self.groupBox_3)
        ...
        self.linac1_Corr2_Max = QtGui.QDoubleSpinBox(self.groupBox_5)
        self.linac1_Corr2_Max.setDecimals(1)
        self.linac1_Corr2_Max.setMinimum(-5.0)
        self.linac1_Corr2_Max.setMaximum(5.0)
        self.linac1_Corr2_Max.setSingleStep(0.1)
        self.linac1_Corr2_Max.setProperty("value", 5.0)
        self.linac1_Corr2_Max.setObjectName(_fromUtf8("linac1_Corr2_Max"))
        self.gridLayout_4.addWidget(self.linac1_Corr2_Max, 5, 2, 1, 1)
        self.label_13 = QtGui.QLabel(self.groupBox_5)
        self.label_13.setAlignment(QtCore.Qt.AlignCenter)
        self.label_13.setObjectName(_fromUtf8("label_13"))
        self.gridLayout_4.addWidget(self.label_13, 3, 2, 1, 1)
        self.linac1_Corr1_Max = QtGui.QDoubleSpinBox(self.groupBox_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.linac1_Corr1_Max.sizePolicy().hasHeightForWidth())
        self.linac1_Corr1_Max.setSizePolicy(sizePolicy)
        self.linac1_Corr1_Max.setMinimumSize(QtCore.QSize(100, 0))
        self.linac1_Corr1_Max.setDecimals(1)
        self.linac1_Corr1_Max.setMinimum(-5.0)
        self.linac1_Corr1_Max.setMaximum(5.0)
        self.linac1_Corr1_Max.setSingleStep(0.1)
        self.linac1_Corr1_Max.setProperty("value", 5.0)
        self.linac1_Corr1_Max.setObjectName(_fromUtf8("linac1_Corr1_Max"))
        self.gridLayout_4.addWidget(self.linac1_Corr1_Max, 4, 2, 1, 1)
        self.label_12 = QtGui.QLabel(self.groupBox_5)
        self.label_12.setAlignment(QtCore.Qt.AlignCenter)
        self.label_12.setObjectName(_fromUtf8("label_12"))
        self.gridLayout_4.addWidget(self.label_12, 3, 1, 1, 1)
        self.linac1_Corr2_Min = QtGui.QDoubleSpinBox(self.groupBox_5)
        self.linac1_Corr2_Min.setDecimals(1)
        self.linac1_Corr2_Min.setMinimum(-5.0)
        self.linac1_Corr2_Min.setMaximum(5.0)
        self.linac1_Corr2_Min.setSingleStep(0.1)
        self.linac1_Corr2_Min.setProperty("value", -5.0)
        self.linac1_Corr2_Min.setObjectName(_fromUtf8("linac1_Corr2_Min"))
        self.gridLayout_4.addWidget(self.linac1_Corr2_Min, 5, 1, 1, 1)
        self.linac1_Corr1_Min = QtGui.QDoubleSpinBox(self.groupBox_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.linac1_Corr1_Min.sizePolicy().hasHeightForWidth())
        self.linac1_Corr1_Min.setSizePolicy(sizePolicy)
        self.linac1_Corr1_Min.setMinimumSize(QtCore.QSize(100, 0))
        self.linac1_Corr1_Min.setDecimals(1)
        self.linac1_Corr1_Min.setMinimum(-5.0)
        self.linac1_Corr1_Min.setMaximum(5.0)
        self.linac1_Corr1_Min.setSingleStep(0.1)
        self.linac1_Corr1_Min.setProperty("value", -5.0)
        self.linac1_Corr1_Min.setObjectName(_fromUtf8("linac1_Corr1_Min"))
        self.gridLayout_4.addWidget(self.linac1_Corr1_Min, 4, 1, 1, 1)
        ...
        self.roughStepSetCorrector.setDecimals(1)
        ...
        self.fineStepSetCorrector_2 = QtGui.QDoubleSpinBox(self.groupBox_5)
        self.fineStepSetCorrector_2.setDecimals(1)
        self.fineStepSetCorrector_2.setMaximum(5.0)
        self.fineStepSetCorrector_2.setSingleStep(0.1)
        self.fineStepSetCorrector_2.setProperty("value", 0.1)
        self.fineStepSetCorrector_2.setObjectName(_fromUtf8("fineStepSetCorrector_2"))
        self.gridLayout_4.addWidget(self.fineStepSetCorrector_2, 1, 2, 1, 1)
        ...
        self.nSamples = QtGui.QLineEdit(self.groupBox1)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.groupBox1, 1, 1, 1, 1)
        ...
        self.centralWidgetLayout.addWidget(self.groupBox, 2, 0, 2, 1)
        ...
        self.linacTabLayout.addItem(spacerItem1, 2, 0, 2, 1)
        icon2 = QtGui.QIcon()
        ...
        self.groupBox_31 = QtGui.QGroupBox(self.SOL2Tab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.formLayout_5 = QtGui.QFormLayout(self.groupBox_31)
        ...
        self.sol2LowerSet = QtGui.QSpinBox(self.groupBox_31)
        ...
        self.label_10 = QtGui.QLabel(self.groupBox_31)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.formLayout_5.setWidget(1, QtGui.QFormLayout.LabelRole, self.label_10)
        self.sol2UpperSet = QtGui.QSpinBox(self.groupBox_31)
        ...
        self.gridLayout_2.addWidget(self.groupBox_31, 0, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.linac1_Corr2_Max.setSuffix(_translate("MainWindow", " A", None))
        self.label_13.setText(_translate("MainWindow", "Max", None))
        self.linac1_Corr1_Max.setSuffix(_translate("MainWindow", " A", None))
        self.label_12.setText(_translate("MainWindow", "Min", None))
        self.linac1_Corr2_Min.setSuffix(_translate("MainWindow", " A", None))
        self.linac1_Corr1_Min.setSuffix(_translate("MainWindow", " A", None))
        ...
        self.fineStepSetCorrector_2.setSuffix(_translate("MainWindow", " A", None))
        self.label_8.setText(_translate("MainWindow", "Approximate", None))
        self.label_9.setText(_translate("MainWindow", "Fine", None))
        self.groupBox1.setTitle(_translate("MainWindow", "BPM Settings", None))
        ...
        self.groupBox_31.setTitle(_translate("MainWindow", "Solenoid Settings", None))
