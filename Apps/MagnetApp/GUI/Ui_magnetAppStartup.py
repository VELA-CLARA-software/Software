...
class Ui_magnetAppStartup(object):
    def setupUi(self, magnetAppStartup):
        ...
        self.CLARA_2_BA1_BA2 = QtGui.QRadioButton(self.machineAreaSelection)
        self.CLARA_2_BA1_BA2.setObjectName(_fromUtf8("CLARA_2_BA1_BA2"))
    ...
    def retranslateUi(self, magnetAppStartup):
        ...
        self.CLARA_2_BA1_BA2.setText(_translate("magnetAppStartup", "CLARA 2 BA1 and BA2", None))
