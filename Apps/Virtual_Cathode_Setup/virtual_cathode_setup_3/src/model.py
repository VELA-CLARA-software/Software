...
class model():
    ...
    def __init__(self):
        ...
        self.initShut = shut.init()
        self.initShut.setVerbose()
        self.shutter = self.initShut.physical_PIL_Shutter_Controller()
        ...
        '''
        self.shutter1  = [self.shutter.getShutterObjConstRef('SHUT01')]#MAGIC_STRING
        self.shutter2  = [self.shutter.getShutterObjConstRef('SHUT02')]#MAGIC_STRING
        self.mirror   = [self.pil.getpilMirrorObjConstRef()]
        self.vc_data  = [self.pil.getVCDataObjConstRef()]
        self.vc_daq   = [self.pil.getClaraDAQObj_VC()]
        self.pil_obj  = [self.pil.getPILObjConstRef()]
        self.vc_cam   = [self.pil.getCameraObj_VC()]
        self.vc_image = [self.pil.getImageObj_VC()]
        self.vc_state = [self.pil.getStateObj_VC()]
        self.vc_mask  = [self.pil.getMaskObj_VC()]
        '''
            Some constants
        '''
    ...
    def update_values(self):
        ...
        '''
        self.values[self.data.is_acquiring] = self.pil.isAcquiring_VC()
        self.values[self.data.is_analysing] = self.pil.isAnalysing_VC()
        self.values[self.data.is_collecting_or_saving] = self.pil.isNotBusy_VC()
    ...
    def set_delta_hwp(self, delta_value):
        self.pil.setHWP(self.pil_obj[0].HWP + delta_value)
