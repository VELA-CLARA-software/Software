...
class model():
    ...
    def __init__(self):
        ...
        model.data.values[data.xpix_full] = model.data.values[data.num_pix_x] * \
                                            model.data.values[data.x_pix_scale_factor]
        model.data.values[data.ypix_full] = model.data.values[data.num_pix_y] * \
                                            model.data.values[data.y_pix_scale_factor]
        # get a fake image to start things off (plus used when debugging)
        model.data.values[data.image]  = self.get_fake_image()

        #print(model.data.values[data.x_pix_to_mm])
        #print(model.data.values[data.x_pix_to_mm])
        #print(model.data.values[data.x_pix_to_mm])
        #print(model.data.values[data.x_pix_to_mm])
        #print(model.data.values[data.x_pix_to_mm])
    ...
    def get_fake_image(self):
        rows = model.data.values[data.num_pix_y]
        columns = model.data.values[data.num_pix_x]
