...
sys.path.append('.')
import virtual_cathode_model as model
from virtual_cathode_view import virtual_cathode_view
...
class virtual_cathode_controller(QtGui.QApplication):
    ...
    It owns a timer that updates the model data
    '''
    ...
    def __init__(self, sys_argv = None):
        ...
        self.model = model.virtual_cathode_model()
        self.view = virtual_cathode_view()
