...
class bpm_handler(bpm_handler_base):
    ...
    def read_attenuation(self, pv, value):
        self.ra1 = bpm_handler_base.bpm_control.getRA1(pv)
        self.ra2 = bpm_handler_base.bpm_control.getRA2(pv)
        bpm_handler_base.logger.message('RA1 = ' + self.ra1 + ' for ' + pv, True)
        bpm_handler_base.logger.message('RA2 = ' + self.ra2 + ' for ' + pv, True)
