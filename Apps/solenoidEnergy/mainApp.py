...
class App(QtCore.QObject):
    def __init__(self, app, sys_argv):
        ...
        self.MainWindow.setWindowIcon(QtGui.QIcon(':/solenoidEnergy.png'))
        splash_pix = QtGui.QPixmap(':/solenoidEnergy.jpg')
        ...
        self.splash.show()
        self.splash.showMessage("<h1><font color='#6BBAFD'>solenoidEnergy Initialising...</font></h1>", QtCore.Qt.AlignTop | QtCore.Qt.AlignCenter, QtCore.Qt.black)
