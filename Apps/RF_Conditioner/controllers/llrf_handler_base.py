...
class llrf_handler_base(object):
	...
	def set_mean_pwr_position(self):
		...
		self.get_pulse_end()
		meantime= int(self.llrf_param['MEAN_TIME_TO_AVERAGE'] / self.timevector_dt  )
		...
		print(self.my_name + ' llrfObj[0].pulse_latency = '  + str(self.llrfObj[0].pulse_latency))
		print(self.my_name + ' self.llrf.getPulseLength() = ' + str(self.llrf.getPulseLength()) )
