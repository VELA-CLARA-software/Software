...
class spike_monitor(monitor.monitor):
    ...
    def __init__(self,
        ...
        self.gui_dict_val_key = gui_dict_val_key
        self.gui_dict_state_key = gui_dict_state_key
        ...
        try:
            self._vac_num_samples_to_average = settings_dict[num_samples_to_average_key]
        except:
    ...
    def check_for_spike(self):
        ...
        if self._latest_value > self.spike_delta + self._mean_level:
            ...
            if len(self._value_history) > self._vac_num_samples_to_average:
    ...
    def update_value(self):
        ...
        if value.keys()[0] != self._reading_counter:
            ...
            self.gui_dict[0][self.gui_dict_val_key] = self._latest_value
    ...
    def set_bad(self):
        ...
        self.gui_dict[0][self.gui_dict_state_key] = monitor.state.BAD

    def set_good(self):
        self.state_dict[0][self.state_dict_key] = monitor.state.GOOD
        self.gui_dict[0][self.gui_dict_state_key] = monitor.state.GOOD