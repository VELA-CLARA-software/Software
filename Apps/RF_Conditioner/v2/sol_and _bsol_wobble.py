...
# sine wave paramters
mean_current_sol = 150 # the nominal setting of the solenoid Max 250, (or maybe 300) 
Amplitude_sol  = 10 # +- Amps from nominal_current (peak of sin wave)
...
numPoints_sol = 200 # number of points per period 
numPoints_Bsol = 200 # number of points per period 
