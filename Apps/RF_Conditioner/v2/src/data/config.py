...
class config(object):
    ...
    DATA_TEXT_LOG_FILENAME = 'DATA_TEXT_LOG_FILENAME'
    ...
    AMP_POWER_LOG_FILENAME = 'AMP_POWER_LOG_FILENAME'
    DATA_LOG_TIME = 'DATA_LOG_TIME'
    AMP_PWR_LOG_TIME = 'AMP_PWR_LOG_TIME'
    log_keywords = [TEXT_LOG_FILENAME, LOG_DIRECTORY, DATA_TEXT_LOG_FILENAME,
                    OUTSIDE_MASK_FORWARD_FILENAME,
                    OUTSIDE_MASK_REVERSE_FILENAME, OUTSIDE_MASK_PROBE_FILENAME,
                    PULSE_COUNT_BREAKDOWN_LOG_FILENAME, PULSE_COUNT_BREAKDOWN_LOG_FILENAME,
                    AMP_POWER_LOG_FILENAME, DATA_LOG_TIME, AMP_PWR_LOG_TIME]
    #
