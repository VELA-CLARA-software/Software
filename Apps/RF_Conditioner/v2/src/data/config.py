...
class config(object):
    ...
    VAC_SPIKE_TRACES_TO_SAVE = 'VAC_SPIKE_TRACES_TO_SAVE'
    CFPOWMASK_LO_MIN = 'CFPOWMASK_LO_MIN'
    CRPOWMASK_LO_MIN = 'CRPOWMASK_LO_MIN'
    CPPOWMASK_LO_MIN = 'CPPOWMASK_LO_MIN'
    KFPOWMASK_LO_MIN = 'KFPOWMASK_LO_MIN'
    KRPOWMASK_LO_MIN = 'KRPOWMASK_LO_MIN'
    CFPHAMASK_LO_MIN = 'CFPHAMASK_LO_MIN'
    CRPHAMASK_LO_MIN = 'CRPHAMASK_LO_MIN'
    CPPHAMASK_LO_MIN = 'CPPHAMASK_LO_MIN'
    KFPHAMASK_LO_MIN = 'KFPHAMASK_LO_MIN'
    KRPHAMASK_LO_MIN = 'KRPHAMASK_LO_MIN'
