...
class bpm_handler(bpm_handler_base):
    ...
    def find_min_dly_1(self):
        ...
        bpm_handler_base.data.values[dat.dv1_dly1_min_val] = min(bpm_handler_base.data.values[dat.dv1_dly1].values())
    ...
    def find_min_dly_2(self):
        bpm_handler_base.data.values[dat.dv1_dly2_min_val] = min(bpm_handler_base.data.values[dat.dv1_dly2].values())
        bpm_handler_base.data.values[dat.dv2_dly2_min_val] = min(bpm_handler_base.data.values[dat.dv2_dly2].values())
        bpm_handler_base.data.values[dat.new_dly_2] = int(numpy.mean(bpm_handler_base.data.values[dat.dv1_dly2_min_val] + bpm_handler_base.data.values[dat.dv2_dly2_min_val]))
        self.set_dly_1(bpm_handler_base.data.values[dat.bpm_name],bpm_handler_base.data.values[dat.new_dly_2])
        self.read_delay(bpm_handler_base.data.values[dat.bpm_name])
