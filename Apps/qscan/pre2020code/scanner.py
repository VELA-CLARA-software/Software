...
#import VELA_CLARA_Charge_Control as cam
...
#0#                a = pil_control.setVCPos(x,y)
                # monitor  this paramter to know when ity has finished
                set_pos_succes = False
#        exit()

#0#                while 1:
#0#                    set_pos_state = pil_control.getSetVCPosState()
#0#                    print('success status', set_pos_state)
#0#                    if set_pos_state == pil.VC_SET_POS_STATE.SUCCESS:
#0#                        set_pos_succes = True
#0#                        break
#0#                    else:
#0#                        print(set_pos_state)
#0#                    time.sleep(1)
#0#                print("Set Position Finished",pil_control.getSetVCPosState())
...
#0#                pil_control.collectAndSave(1)
                time.sleep(2)
