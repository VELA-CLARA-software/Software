...
class calc():
	...
	def newsetpoint(self):
		return 9.4868*10**-7 *(-3.35842*10**9 + 0.0000981135 *(1.17169*10**27 + 4.38841*10**21 *self.klypower*10**6)**0.5)
		
	def newklypower(self):
		return (167.603*self.setpoint + 0.0263024 *self.setpoint**2)*10**-6
