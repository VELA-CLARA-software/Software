...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.blmPlot.disableAutoRange()
        self.vbx = self.blmPlot.vb
        self.vbx.setYRange(-500, 500)
        self.vbx.setXRange(0.0, 17.0)
        self.plotHBox.addWidget(self.blmPlotView)
        self.figHBox = QtGui.QHBoxLayout(self.mainWidget)
        self.padLabel = QtGui.QLabel()
        self.padLabel.setMinimumSize(QtCore.QSize(70,64))
        self.padLabel.setMaximumSize(QtCore.QSize(70,64))
        self.figLabel = QtGui.QLabel()
        self.pixMap = QtGui.QPixmap("beamlinemap no names no coordinates.png")
        # self.pixMap.scaled(264, 64, QtCore.Qt.KeepAspectRatioByExpanding)
        self.figLabel.setPixmap(self.pixMap)
        self.figLabel.setMinimumSize(QtCore.QSize(1100, 64))
        self.figLabel.setMaximumSize(QtCore.QSize(1100, 64))
        self.figHBox.addWidget(self.padLabel)
        ...
        self.saveDataButton.setMinimumSize(QtCore.QSize(1000, 50))
        self.saveDataButton.setMaximumSize(QtCore.QSize(1000, 50))
