...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rollingAverageLabel = QtGui.QLabel()
        self.rollingAverageLabel.setObjectName(_fromUtf8("rollingAverageLabel"))
        self.rollingAverageOutputWidget = QtGui.QPlainTextEdit()
        self.rollingAverageOutputWidget.setObjectName(_fromUtf8("rollingAverageOutputWidget"))
        self.rollingAverageOutputWidget.setMaximumSize(QtCore.QSize(30, 30))
        self.rollingAverageOutputWidget.setMinimumSize(QtCore.QSize(30, 30))
        ...
        self.numShotsHBox.addWidget(self.rollingAverageLabel)
        self.numShotsHBox.addWidget(self.rollingAverageOutputWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rollingAverageLabel.setText(_translate("MainWindow", "Rolling average", None))
        self.rollingAverageOutputWidget.setPlainText(_translate("MainWindow", "0", None))
