...
class striptool_Demo(qt.QMainWindow):
    def __init__(self, parent = None):
        ...
        self.generalplot.addSignal(name='signal1', pen='g', timer=1.0/100.0, function=self.createRandomSignal, args=[0,2,42.5])
        self.generalplot.addSignal(name='signal2', pen='r', timer=1.0/10.0, function=self.createRandomSignal, args=[10,0.4,2.316, 2], logScale=False)
