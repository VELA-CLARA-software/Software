...
import VELA_CLARA_General_Monitor as general_controller
genC = general_controller.init()
...
class PV(QObject):
    def __init__(self, name, callback=None):
        ...
        self.pvid = genC.connectPV(self.name)
        self.timer = Timer(0.01, self.callback)

    def get(self):
        return genC.getValue(self.pvid)
