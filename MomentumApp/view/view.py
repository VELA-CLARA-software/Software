...
# Form implementation generated from reading ui file 'view1_1.ui'
#
...
"}"))
        ...
        self.groupBox_run.setMinimumSize(QtCore.QSize(300, 0))
        self.groupBox_run.setMaximumSize(QtCore.QSize(300, 16777215))
        self.groupBox_run.setObjectName(_fromUtf8("groupBox_run"))
        self.gridLayout = QtGui.QGridLayout(self.groupBox_run)
        self.gridLayout.setObjectName(_fromUtf8("gridLayout"))
        self.pushButton = QtGui.QPushButton(self.groupBox_run)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton.sizePolicy().hasHeightForWidth())
        self.pushButton.setSizePolicy(sizePolicy)
        self.pushButton.setMinimumSize(QtCore.QSize(281, 121))
        self.pushButton.setMaximumSize(QtCore.QSize(281, 121))
        self.pushButton.setObjectName(_fromUtf8("pushButton"))
        self.gridLayout.addWidget(self.pushButton, 0, 0, 1, 2)
        self.checkBox_1 = QtGui.QCheckBox(self.groupBox_run)
        ...
        self.checkBox_1.setMinimumSize(QtCore.QSize(140, 0))
        ...
        self.label_predictMom = QtGui.QLabel(self.groupBox_run)
        self.label_predictMom.setObjectName(_fromUtf8("label_predictMom"))
        self.gridLayout.addWidget(self.label_predictMom, 1, 1, 1, 1)
        self.checkBox_all = QtGui.QCheckBox(self.groupBox_run)
        self.checkBox_all.setChecked(True)
        self.checkBox_all.setObjectName(_fromUtf8("checkBox_all"))
        self.gridLayout.addWidget(self.checkBox_all, 1, 0, 1, 1)
        self.lineEdit_predictMom = QtGui.QLineEdit(self.groupBox_run)
        self.lineEdit_predictMom.setObjectName(_fromUtf8("lineEdit_predictMom"))
        self.gridLayout.addWidget(self.lineEdit_predictMom, 2, 1, 1, 1)
        self.textEdit = QtGui.QTextEdit(self.groupBox_run)
        self.textEdit.setObjectName(_fromUtf8("textEdit"))
        self.gridLayout.addWidget(self.textEdit, 9, 0, 1, 2)
        self.checkBox_4 = QtGui.QCheckBox(self.groupBox_run)
        self.checkBox_4.setChecked(True)
        self.checkBox_4.setObjectName(_fromUtf8("checkBox_4"))
        self.gridLayout.addWidget(self.checkBox_4, 6, 0, 1, 1)
        self.checkBox_2 = QtGui.QCheckBox(self.groupBox_run)
        self.checkBox_2.setChecked(True)
        self.checkBox_2.setObjectName(_fromUtf8("checkBox_2"))
        self.gridLayout.addWidget(self.checkBox_2, 3, 0, 1, 1)
        self.checkBox_3 = QtGui.QCheckBox(self.groupBox_run)
        ...
        self.gridLayout.addWidget(self.pushButton_refreshImage, 7, 0, 1, 2)
        ...
        self.groupBox_s_run.setMinimumSize(QtCore.QSize(300, 0))
        self.groupBox_s_run.setMaximumSize(QtCore.QSize(300, 16777215))
        ...
        self.checkBox_all_s = QtGui.QCheckBox(self.groupBox_s_run)
        self.checkBox_all_s.setChecked(True)
        self.checkBox_all_s.setObjectName(_fromUtf8("checkBox_all_s"))
        self.gridLayout_2.addWidget(self.checkBox_all_s, 2, 0, 1, 1)
        self.checkBox_3_s = QtGui.QCheckBox(self.groupBox_s_run)
        self.checkBox_3_s.setChecked(True)
        self.checkBox_3_s.setObjectName(_fromUtf8("checkBox_3_s"))
        self.gridLayout_2.addWidget(self.checkBox_3_s, 5, 0, 1, 1)
        self.checkBox_4_s = QtGui.QCheckBox(self.groupBox_s_run)
        self.checkBox_4_s.setChecked(True)
        self.checkBox_4_s.setObjectName(_fromUtf8("checkBox_4_s"))
        self.gridLayout_2.addWidget(self.checkBox_4_s, 7, 0, 1, 1)
        self.checkBox_2_s = QtGui.QCheckBox(self.groupBox_s_run)
        self.checkBox_2_s.setChecked(True)
        self.checkBox_2_s.setObjectName(_fromUtf8("checkBox_2_s"))
        self.gridLayout_2.addWidget(self.checkBox_2_s, 4, 0, 1, 1)
        self.textEdit_s = QtGui.QTextEdit(self.groupBox_s_run)
        self.textEdit_s.setObjectName(_fromUtf8("textEdit_s"))
        self.gridLayout_2.addWidget(self.textEdit_s, 9, 0, 1, 2)
        self.checkBox_1_s = QtGui.QCheckBox(self.groupBox_s_run)
        self.checkBox_1_s.setChecked(True)
        self.checkBox_1_s.setObjectName(_fromUtf8("checkBox_1_s"))
        self.gridLayout_2.addWidget(self.checkBox_1_s, 3, 0, 1, 1)
        self.pushButton_s = QtGui.QPushButton(self.groupBox_s_run)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Maximum, QtGui.QSizePolicy.Maximum)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.pushButton_s.sizePolicy().hasHeightForWidth())
        self.pushButton_s.setSizePolicy(sizePolicy)
        self.pushButton_s.setMinimumSize(QtCore.QSize(281, 121))
        self.pushButton_s.setMaximumSize(QtCore.QSize(281, 121))
        self.pushButton_s.setObjectName(_fromUtf8("pushButton_s"))
        self.gridLayout_2.addWidget(self.pushButton_s, 1, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.pushButton_refreshProfile, 8, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton.setText(_translate("MainWindow", "Get Momentum", None))
        self.checkBox_1.setText(_translate("MainWindow", "1. Preliminaries", None))
        self.label_predictMom.setText(_translate("MainWindow", "Predicted Momentum:", None))
        self.checkBox_all.setText(_translate("MainWindow", "Select All", None))
        self.checkBox_4.setText(_translate("MainWindow", "4.Calculate Momentum", None))
        self.checkBox_2.setText(_translate("MainWindow", "2. Align Through Dipole", None))
        self.checkBox_3.setText(_translate("MainWindow", "3.Centre Down Spectometer Line", None))
        ...
        self.checkBox_1_s.setText(_translate("MainWindow", "1. Checks", None))
