...
class Ui_MainWindow(QtCore.QObject):
    def setupUI(self, TabWidget):
        ...
        self.xPlot = MyDynamicMplCanvas(self.tab1, width=5, height=4, dpi=100, data = self.data1)
        self.yPlot = MyDynamicMplCanvas(self.tab1, width=5, height=4, dpi=100, data = self.data1)
    ...
    def setComboBox(self, TabWidget):
        ...
        self.comboBox.addItem(_fromUtf8(""))
        self.comboBox.addItem(_fromUtf8(""))
        if self.trajectoryButton.isChecked():
        ...
        elif self.individualButton.isChecked():
